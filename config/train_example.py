...
def train(task: str, data_path: str = None, device: str = "0"):
    ...
    Args:
        task: 任务类型，可选 armor_pose, rune_pose, armor_detect
    ...
    task_configs = {
        ...
        "rune_pose": {
            "model": config_dir / "models/rune/rune-pose-mobilenet.yaml",
            "data": config_dir / "datasets/rune.yaml",
            "hyp": config_dir / "hyperparams/rune_pose.yaml",
        },
        "armor_detect": {
...
if __name__ == "__main__":
    ...
    parser.add_argument("--task", type=str, required=True,
                        choices=["armor_pose", "rune_pose", "armor_detect"],
                        help="Task to train")
